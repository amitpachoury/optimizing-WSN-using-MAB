...
import pandas as pd
s_ch = pd.read_csv('summary_channel.csv')
s_rt = pd.read_csv('summary_routing.csv')
s_pw = pd.read_csv('summary_power.csv')
s_dc = pd.read_csv('summary_dutycycle.csv')

summary = {
	'Channel': s_ch.to_dict(orient='records'),
	'Routing': s_rt.to_dict(orient='records'),
	'Power': s_pw.to_dict(orient='records'),
	'DutyCycle': s_dc.to_dict(orient='records'),
}
print(summary)
